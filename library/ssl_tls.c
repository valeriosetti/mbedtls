...
#if defined(PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY) && defined(PSA_WANT_ALG_SHA_512)
    MBEDTLS_TLS1_3_SIG_RSA_PKCS1_SHA512,
#endif /* PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY && PSA_WANT_ALG_SHA_512 */

#if defined(PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY) && defined(PSA_WANT_ALG_SHA_384)
    MBEDTLS_TLS1_3_SIG_RSA_PKCS1_SHA384,
#endif /* PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY && PSA_WANT_ALG_SHA_384 */

#if defined(PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY) && defined(PSA_WANT_ALG_SHA_256)
    MBEDTLS_TLS1_3_SIG_RSA_PKCS1_SHA256,
#endif /* PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY && PSA_WANT_ALG_SHA_256 */
...
void mbedtls_ssl_config_free(mbedtls_ssl_config *conf)
{
    ...
    (defined(PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY) || \
...
#endif /* MBEDTLS_PK_C &&
          ( PSA_HAVE_ALG_RSA_SIGN_OR_VERIFY || MBEDTLS_KEY_EXCHANGE_ECDSA_CERT_REQ_ANY_ALLOWED_ENABLED ) */
